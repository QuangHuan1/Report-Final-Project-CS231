...
def BayesianMatting(kernel_size, min_pix, sigma, threshold, max_it, Ground_Truth
  ...
  Background = Background / 255  # Background

  #removed = composite_bg(Original_Image, Background, Ground_Truth, scale_percent = 100)
  ...
  new_image = composite_bg(foreground_color, Background, new_alpha_map, scale_percent = 100)
  ...
  return new_alpha_map, diff, final_im, im_diff, new_fore, new_image